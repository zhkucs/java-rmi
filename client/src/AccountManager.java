	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals(AccountManager.VALIDATE_SAVE)) {
			...
			try {
				...
				facade = (CustomerIntr) Naming.lookup("rmi://" + objAccountManager.getRMIHost() + ":"
						+ objAccountManager.getRMIPort() + "/CustomerFacade");
				...
				System.out.println("Error: Please check to ensure the " + "remote server is running" + ex.getMessage());
			}
